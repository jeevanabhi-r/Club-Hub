      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900/20 p-4 rounded-xl border border-slate-800/60">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-lg bg-slate-950/60 py-1.5 pl-9 pr-3 text-xs text-slate-200 placeholder-slate-650 border border-slate-800 focus:border-emerald-500 focus:outline-none"
            value={search}
